...
"""Convert plain text or timed segments to an SRT subtitle file."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=__doc__,
        epilog="Example: uv run to-srt.py --text 'Hello world.' --duration 5",
    )
    parser.add_argument(
        "--input",
        "-i",
...
def main() -> None:
    ...
    out = resolve_output(args.input, ".srt", args.output)
