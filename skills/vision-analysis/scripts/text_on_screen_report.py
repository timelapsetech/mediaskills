...
"""Timecoded report of all classified on-screen text."""
...
OP = "vision.text_on_screen_report"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=__doc__,
        epilog="Example: uv run text_on_screen_report.py --analysis-path clip_frame_analysis.json",
    )
...
def main() -> None:
    ...
    if maybe_emit_reused_report(
        OP, args.force, str(resolved), "text_on_screen", include, exclude
    ):
        return
